...
class Particula:
    def __init__(self, Id = 0, origen_X = 0, origen_Y = 0, destino_X = 0, destino_Y = 0, velocidad = 0, rojo = 0, verde = 0, azul = 0, distancia = 0):
        ...
        self.__verde = verde
        self.__azul = azul
        self.distancia = int(distancia_euclidiana(origen_X, origen_Y, destino_X, destino_Y))
    ...
    def origenInicial(self):
        return (self.__origenX, self.__origenY)
    
    def getDestino(self):
        return str("(" + str(self.__destinoX) + ", " + str(self.__destinoY) + ")")

    def destinoFinal(self):
        return (self.__destinoX, self.__destinoY)
